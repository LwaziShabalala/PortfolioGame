...
export const dialogueData = {
  pc: `This is my PC. I work mostly in JavaScript/TypeScript these days.
    ...
    Here is my <a href="https://github.com/LwaziShabalala" target="_blank">Github</a>!`,
  ...
  library: `There are a lot of programming books on my shelves. There is even one in French (I'm trying to learn french).
  I probably only read one of them. Who else compulsively buys technical books without ever finishing them?`,
  exit: `If you want to exit Lwazi Shabalala's portfolio, just close the tab.`,
};